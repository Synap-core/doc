...
- [OpenClaw Integration State](./openclaw-integration.mdx) — Skill installation flow and integration architecture
- [OpenClaw Channel Interactions](./openclaw-channels.mdx) — How the skill relays messages through Synap channels
