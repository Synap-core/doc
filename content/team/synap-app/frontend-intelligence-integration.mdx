...
- [AI Capabilities Guide](../intelligence/ai-capabilities-guide.mdx) — Feature surface for intelligence integration
- [Frontend AI Reference](./frontend-ai-reference.mdx) — Frontend development reference for AI features
- [Hub Protocol](../platform/hub-protocol.mdx) — Message protocol between backend and frontend intelligence
- [Multi-agent Orchestrator](../intelligence/multi-agent-orchestrator.mdx) — Agent architecture for intelligence service
