...
- [CLI property types](./cli-property-types.mdx) — value types and constraints referenced by schema
- [CLI view types](./cli-view-types.mdx) — view configs reference profile slugs defined here
