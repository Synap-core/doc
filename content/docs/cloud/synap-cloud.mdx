...
- [Infrastructure Architecture](/team/devops/infrastructure-architecture) — system architecture and components
- [Pod installation](/team/control-plane/pod-install) — provisioning your pod through the control plane
- [Pod management](/team/control-plane/pod-management) — pod lifecycle and operational controls
