...
- [Property types](./property-types.mdx) — value types and constraints for schema fields
- [CLI property types](./cli-property-types.mdx) — CLI version of property type definitions
- [View types](./view-types.mdx) — view configs reference the profiles defined here
