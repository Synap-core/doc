...
- [CLI synap skill](./cli-synap-skill.mdx) — CLI version of this document
- [Agent SDK](../platform/agent-sdk.mdx) — extending agent capabilities beyond core ops
- [UI specification](../design/ui-specification.mdx) — tokens used by agent-rendered UI
