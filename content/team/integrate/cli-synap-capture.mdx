...
- [CLI synap schema](./cli-synap-schema.mdx) — referenced profiles and property types
- [Capture pipeline](./synap-capture.mdx) — same pipeline, UI version
- [CLI view types](./cli-view-types.mdx) — structured output can be fed into views
