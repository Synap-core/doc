...
- [Database migrations](./database-migrations.mdx) — Schema migration rules and safety procedures
- [Delivery service migration](./delivery-service-migration.mdx) — Migration from legacy patterns
- [Rollback strategy](./rollback-strategy.mdx) — Safe rollback procedures for failed migrations
- [Deployment](./database-migrations.mdx) — Migration runner and schema coherence
