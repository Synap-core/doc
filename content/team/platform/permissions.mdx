...
> **Canonical scope (team):** implementation and operational behavior for permission validation.
> Public-facing model: [/docs/architecture/permission-model](/docs/architecture/permission-model)
>
> **Related internal docs:** [Proposals](/team/platform/proposals) · [Event chain](/team/platform/event-chain) · [Golden flows](/team/platform/golden-flows)
...
- [Security & Permissions](./security.mdx) — Three-layer security model (auth → RBAC → AI governance)
- [Auth Architecture](./auth-architecture.mdx) — Authentication foundation that permissions build upon
- [Proposals & Governance](./proposals.mdx) — Proposal-based governance integrated with permission validation
