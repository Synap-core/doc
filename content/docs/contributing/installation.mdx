...
- [Installation fix guide](/team/deploy/installation-fix-guide) — backend and intelligence hub integration fixes
- [Development setup](/docs/integrate/development/setup) — running Synap locally
- [Legacy dev guide](./dev-guide-legacy) — monohub, architecture overview, and running locally
