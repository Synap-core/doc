...
- [Deployment strategies](./deployment-strategies.mdx) — Image-based and source-based deployment approaches with hybrid fallback
- [Troubleshooting](./troubleshooting.mdx) — Common issues and solutions for self-hosted instances
- [Pod backups](../../backend/pod-backups.mdx) — Backup procedures for dedicated pods
