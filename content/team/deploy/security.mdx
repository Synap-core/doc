...
- [Security practices](./security.mdx) — Secret management and rotation runbooks
- [Auth architecture](../../backend/auth-architecture.mdx) — Ory Kratos/Hydra identity system
- [Security architecture](../../deploy/security-architecture.mdx) — Full system security model
- [Pod security](../../backend/pod-backups.mdx) — Pod-level security and secrets
