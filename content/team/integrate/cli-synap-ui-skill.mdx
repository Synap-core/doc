...
- [CLI synap skill](./cli-synap-skill.mdx) — data operations prerequisite for building UI
- [UI specification](../design/ui-specification.mdx) — component tokens used by all UI cells
- [Design guidelines](../design/design-guidelines.mdx) — layout and interaction standards
