...
- [Automation Skill: Update Entity](./skill-update-entity.mdx) — entity updates in automations
- [Automation Skill: View Filters](./skill-automation-view-filters.mdx) — filtering in automation triggers
- [Automation Skill: Delete Entity](./skill-delete-entity.mdx) — deletion in automation contexts
- [Skill: Entity Management](./skill-entities.mdx) — entity creation and updates
