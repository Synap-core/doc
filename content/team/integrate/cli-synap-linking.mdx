...
- [CLI synap schema](./cli-synap-schema.mdx) — entity_id property type enables auto-sync
- [Linking](./synap-linking.mdx) — same linking, UI version
- [Property types](./property-types.mdx) — entity_id value type drives relation creation
