...
- [CLI widget catalog](./cli-widget-catalog.mdx) — same widget definitions, CLI version
- [Bento design system](../design/bento-design.mdx) — widgets compose into dashboard layouts
- [Cell system](../platform/cell-system.mdx) — widgets are cells rendered in containers
