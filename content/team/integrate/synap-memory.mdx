...
- [CLI synap linking](./cli-synap-linking.mdx) — stored facts are linked via properties
- [Session memory](../platform/session-memory.mdx) — conversation-scoped memory
- [Graph vision](../platform/graph-vision.mdx) — knowledge graph future direction
