...
- [CLI user flows](./cli-user-flows) — PATH detection and setup flow specifications
- [CLI contribution guide](./cli-contributing) — contributing to the CLI codebase
- [CLI property types](/team/integrate/cli-property-types) — property types available through the CLI
