...
- [CLI synap schema](./cli-synap-schema.mdx) — views reference profile slugs defined here
- [View types](./view-types.mdx) — same view types, UI version
- [CLI widget catalog](./cli-widget-catalog.mdx) — widgets rendered inside views
