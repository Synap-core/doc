...
- [Backend product](/docs/start/concepts/what-is-synap) — the product overview and architecture
- [Database migrations](/team/backend/database-migrations) — migration rules and conventions
- [Deployment strategies](/team/deploy/deployment-strategies) — image-based and source-based deployment
