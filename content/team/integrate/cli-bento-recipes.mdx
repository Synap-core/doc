...
- [Bento recipes](./bento-recipes.mdx) — same layouts, UI version
- [CLI widget catalog](./cli-widget-catalog.mdx) — how agents reference widget kinds
- [CLI synap capture](./cli-synap-capture.mdx) — structured extraction feeds recipes
