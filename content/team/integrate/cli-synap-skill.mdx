...
- [CLI synap schema](./cli-synap-schema.mdx) — schema extension skill used alongside this one
- [Skills](../platform/skills.mdx) — all OpenClaw skills in the system
- [CLI synap capture](./cli-synap-capture.mdx) — structured text extraction for bulk data ops
