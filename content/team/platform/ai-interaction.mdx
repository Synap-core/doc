...
- [Chat Core](./chat-core.mdx) — Chat hooks/stores extraction plan
- [Chat Architecture](./chat-architecture.mdx) — Unification plan across surfaces
- [Intelligence UX](./intelligence-ux.mdx) — User-facing AI features and UX patterns
- [Hold Menu](./hold-menu.mdx) — Gesture integration for AI actions
- [AI Chat Interface PRD](../intelligence/ai-chat-interface-prd.mdx) — Front-end UX spec for chat screens
