...
- [Realtime](/team/platform/realtime) — Socket.IO, Yjs CRDTs, and collaboration architecture
- [Channel system](/team/platform/channel-system) — channel types, scope, and AI triggers
- [Event chain](/team/platform/event-chain) — event sourcing and worker pipeline
