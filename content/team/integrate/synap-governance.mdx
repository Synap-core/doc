...
- [CLI synap governance](./cli-synap-governance.mdx) — agent-facing version of this document
- [Proposals](../platform/proposals.mdx) — proposal system architecture
- [Permissions](../platform/permissions.mdx) — RBAC and approval rules
