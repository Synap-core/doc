...
- [CLI property types](./cli-property-types.mdx) — same property types, CLI version
- [Synap schema](./synap-schema.mdx) — where property types are referenced
- [View types](./view-types.mdx) — views filter and sort by property types
