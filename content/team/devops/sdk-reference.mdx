...
- [Agent SDK](../intelligence/agent-sdk.mdx) — external developer SDK for IS services
- [Hub Protocol](../platform/hub-protocol.mdx) — backend API contract for external integrations
- [Monitor: Tools](../intelligence/monitor-tools.mdx) — tool usage tracking via SDK
- [Security Audit](../control-plane/audit.mdx) — security review of backend packages
