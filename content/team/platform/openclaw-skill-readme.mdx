---
title: 'OpenClaw Skill Setup'
description: How to install and configure the synap OpenClaw skill.
section: general
audience: users
version: 1.0+
...
- [Openclaw-skill](./openclaw-skill.mdx) — OpenClaw skill implementation
- [Openclaw-integration](./openclaw-integration.mdx) — OpenClaw integration architecture
- [Agent-system](../../intelligence/agent-system.mdx) — Agent system design
