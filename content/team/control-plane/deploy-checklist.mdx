...
- [Release checklist](/team/home/release-checklist)
- [Operations guide](/team/control-plane/operations-guide)
```
...
- [Deployment Strategies](./pod-deploy-strategies.mdx) — image vs source deployment options
- [Rolling Updates](../devops/rolling-updates.mdx) — staged rollout process
- [Operations Guide](./operations-guide.mdx) — manual operational steps
- [GHCR Caching](./ghcr-caching.mdx) — image caching for faster deployments
