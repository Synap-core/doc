...
- [CLI synap schema](./cli-synap-schema.mdx) — schema governs what properties agents can mutate
- [Governance](./synap-governance.mdx) — same governance, UI version
- [Property types](./property-types.mdx) — property constraints feed the auto-approve logic
