...
- [CLI synap linking](./cli-synap-linking.mdx) — agent-facing version of this document
- [Connections](../platform/connections.mdx) — entity connection system
- [Entity profiles](../features/entity-profiles.mdx) — profiles that use linking
